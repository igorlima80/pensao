...
# Brazillian zip-code information https://rubygems.org/gems/via_cep
gem 'via_cep'

# Rails 4/5 task to dump your data to db/seeds.rb
gem 'seed_dump'

# General utilities and partials
gem 'zutils'
...
#A OneSignal API wrapper simplifying user targeted cross platform notifications.
gem 'onsignal'
